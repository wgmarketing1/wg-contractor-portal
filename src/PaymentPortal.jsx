  ...
  if (!currentUser) {
    return (
      <div style={{ minHeight: '100vh', background: `linear-gradient(135deg, ${colors.primary} 0%, ${colors.secondary} 100%)`, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        <div style={{ background: colors.white, borderRadius: '12px', padding: '40px', maxWidth: '400px', width: '100%', boxShadow: '0 10px 40px rgba(0,0,0,0.2)' }}>
          ...
          <div style={{ marginTop: '20px', padding: '12px', background: '#f0f9ff', borderRadius: '6px', border: `1px solid ${colors.secondary}` }}>
            <p style={{ color: colors.primary, fontSize: '12px', margin: 0, lineHeight: '1.5' }}>
              <strong>Demo Accounts:</strong><br />
              Admin: admin@portal.com / admin123<br />
              Team Lead: teamlead@portal.com / team123
            </p>
          </div>
        </div>
      </div>
